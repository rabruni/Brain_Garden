...
# from kernel.agent_{agent_name_short} import {agent_name_short.title().replace("_", "")}Agent
...
def cmd_preflight(args: argparse.Namespace) -> int:
    ...
    from kernel.paths import discover_workspace_files, PACKAGE_META_FILES
...
def cmd_stage(args: argparse.Namespace) -> int:
    ...
    from kernel.paths import discover_workspace_files
    workspace_files = discover_workspace_files(
        src_path,
...
def cmd_check_framework(args: argparse.Namespace) -> int:
    ...
    from kernel.registry import framework_exists as _fw_exists, load_registry_as_dict
...
def cmd_register_framework(args: argparse.Namespace) -> int:
    ...
    from kernel.registry import framework_exists as _fw_exists
...
def cmd_register_spec(args: argparse.Namespace) -> int:
    ...
    # Check if already registered
    from kernel.registry import spec_exists as _sp_exists
    ...
    from kernel.registry import framework_exists as _fw_check
...
def cmd_compliance(args: argparse.Namespace) -> int:
    ...
    """
    from kernel.agent_helpers import CPInspector
