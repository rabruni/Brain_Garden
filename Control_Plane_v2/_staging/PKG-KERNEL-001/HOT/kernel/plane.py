...
- HOT: Highest privilege, cannot be modified by lower planes
- HO2: Middle tier, can reference HOT interfaces
- HO1: Lowest tier, can reference HO2 and HOT interfaces
...
class PlaneType(str, Enum):
    ...
    HOT = "HOT"  # Executive tier (highest privilege)
    HO2 = "HO2"  # Middle tier
    HO1 = "HO1"  # Lowest tier
...
def migrate_plane_type(plane_type_str: str) -> str:
    ...
    Returns:
        Canonical plane type string (HOT, HO2, or HO1)
    """
...
class PlaneContext:
    ...
    def can_reference_plane(self, other_plane_type: PlaneType) -> bool:
        ...
        Direction rules:
        - HOT can reference HO2 and HO1
        - HO2 can reference HO1 only
...
def load_chain_config() -> List[PlaneContext]:
    ...
    Note:
        ...
        automatically migrated to canonical names (HOT, HO2, HO1).
    """
...
def validate_target_plane(manifest_target: str, current_plane: PlaneContext) -> bool:
    ...
    Args:
        manifest_target: target_plane from manifest ("hot", "ho2", "ho1", or "any")
...
def validate_external_interface_direction(
    ...
    - HOT can reference HO2 and HO1 interfaces
    - HO2 can reference HO1 interfaces only
    - HO1 cannot reference other plane interfaces
